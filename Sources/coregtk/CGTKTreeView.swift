...
open class CGTKTreeView : CGTKContainer {
	/// 
	...
	/// Parameters:
	///	- column: UnsafeMutablePointer<GtkTreeViewColumn>!
	/// - Returns: gint
	...
	///	- bx: gint
	///	- by: gint
	///	- tx: UnsafeMutablePointer<Int32>!
	///	- ty: UnsafeMutablePointer<Int32>!
	open func convertBinWindowToTreeCoords(bx: gint, by: gint, tx: UnsafeMutablePointer<Int32>!, ty: UnsafeMutablePointer<Int32>!) {
	...
	///	- bx: gint
	///	- by: gint
	///	- wx: UnsafeMutablePointer<Int32>!
	///	- wy: UnsafeMutablePointer<Int32>!
	open func convertBinWindowToWidgetCoords(bx: gint, by: gint, wx: UnsafeMutablePointer<Int32>!, wy: UnsafeMutablePointer<Int32>!) {
	...
	open func convertTreeToBinWindowCoords(tx: gint, ty: gint, bx: UnsafeMutablePointer<Int32>!, by: UnsafeMutablePointer<Int32>!) {
	...
	///	- wx: UnsafeMutablePointer<Int32>!
	///	- wy: UnsafeMutablePointer<Int32>!
	open func convertTreeToWidgetCoords(tx: gint, ty: gint, wx: UnsafeMutablePointer<Int32>!, wy: UnsafeMutablePointer<Int32>!) {
	...
	///	- tx: UnsafeMutablePointer<Int32>!
	///	- ty: UnsafeMutablePointer<Int32>!
	open func convertWidgetToTreeCoords(wx: gint, wy: gint, tx: UnsafeMutablePointer<Int32>!, ty: UnsafeMutablePointer<Int32>!) {
	...
	/// Parameters:
	///	- path: OpaquePointer!
	open func expandToPath(_ path: OpaquePointer!) {
	...
	open func getBackgroundArea(path: OpaquePointer?, column: UnsafeMutablePointer<GtkTreeViewColumn>?, rect: UnsafeMutablePointer<GdkRectangle>!) {
	...
	///	- column: UnsafeMutablePointer<GtkTreeViewColumn>?
	///	- rect: UnsafeMutablePointer<GdkRectangle>!
	open func getCellArea(path: OpaquePointer?, column: UnsafeMutablePointer<GtkTreeViewColumn>?, rect: UnsafeMutablePointer<GdkRectangle>!) {
	...
	/// Parameters:
	///	- n: gint
	/// - Returns: UnsafeMutablePointer<GtkTreeViewColumn>?
	...
	/// Parameters:
	///	- path: UnsafeMutablePointer<OpaquePointer?>? = nil
	///	- focusColumn: UnsafeMutablePointer<UnsafeMutablePointer<GtkTreeViewColumn>?>? = nil
	open func getCursor(path: UnsafeMutablePointer<OpaquePointer?>? = nil, focusColumn: UnsafeMutablePointer<UnsafeMutablePointer<GtkTreeViewColumn>?>? = nil) {
	...
	///	- dragY: gint
	///	- path: UnsafeMutablePointer<OpaquePointer?>? = nil
	///	- pos: UnsafeMutablePointer<GtkTreeViewDropPosition>!
	/// - Returns: Bool
	...
	///	- path: UnsafeMutablePointer<OpaquePointer?>? = nil
	///	- pos: UnsafeMutablePointer<GtkTreeViewDropPosition>!
	open func getDragDestRow(path: UnsafeMutablePointer<OpaquePointer?>? = nil, pos: UnsafeMutablePointer<GtkTreeViewDropPosition>!) {
	...
	///	- y: gint
	///	- path: UnsafeMutablePointer<OpaquePointer?>? = nil
	///	- column: UnsafeMutablePointer<UnsafeMutablePointer<GtkTreeViewColumn>?>? = nil
	///	- cellX: UnsafeMutablePointer<Int32>!
	///	- cellY: UnsafeMutablePointer<Int32>!
	/// - Returns: Bool
	...
	/// will be returned.
	/// - Returns: UnsafeMutablePointer<GtkEntry>!
	...
	/// - Returns: UnsafeMutablePointer<GtkTreeSelection>!
	...
	///	- keyboardTip: Bool
	///	- model: UnsafeMutablePointer<OpaquePointer?>? = nil
	...
	/// Parameters:
	///	- visibleRect: UnsafeMutablePointer<GdkRectangle>!
	open func getVisibleRect(_ visibleRect: UnsafeMutablePointer<GdkRectangle>!) {
	...
	///	- function: @escaping GtkTreeCellDataFunc
	///	- data: gpointer
	///	- dnotify: @escaping GDestroyNotify
	/// - Returns: gint
	...
	/// Parameters:
	///	- function: @escaping GtkTreeViewMappingFunc
	///	- data: gpointer
	open func mapExpandedRows(function: @escaping GtkTreeViewMappingFunc, data: gpointer) {
	...
	/// Parameters:
	///	- column: UnsafeMutablePointer<GtkTreeViewColumn>!
	///	- baseColumn: UnsafeMutablePointer<GtkTreeViewColumn>?
	open func moveColumnAfter(column: UnsafeMutablePointer<GtkTreeViewColumn>!, baseColumn: UnsafeMutablePointer<GtkTreeViewColumn>?) {
	...
	///	- path: OpaquePointer!
	///	- column: UnsafeMutablePointer<GtkTreeViewColumn>!
	open func rowActivated(path: OpaquePointer!, column: UnsafeMutablePointer<GtkTreeViewColumn>!) {
	...
	///	- rowAlign: Float
	///	- colAlign: Float
	open func scrollToCell(path: OpaquePointer?, column: UnsafeMutablePointer<GtkTreeViewColumn>?, useAlign: Bool, rowAlign: Float, colAlign: Float) {
	...
	///	- treeX: gint
	///	- treeY: gint
	open func scrollToPoint(treeX: gint, treeY: gint) {
	...
	/// dropped everywhere.
	/// Parameters:
	///	- function: @escaping GtkTreeViewColumnDropFunc
	///	- userData: gpointer
	///	- destroy: @escaping GDestroyNotify
	open func setColumnDragFunction(function: @escaping GtkTreeViewColumnDropFunc, userData: gpointer, destroy: @escaping GDestroyNotify) {
	...
	/// Parameters:
	///	- path: OpaquePointer!
	///	- focusColumn: UnsafeMutablePointer<GtkTreeViewColumn>?
	///	- startEditing: Bool
	open func setCursor(path: OpaquePointer!, focusColumn: UnsafeMutablePointer<GtkTreeViewColumn>?, startEditing: Bool) {
	...
	///	- path: OpaquePointer!
	///	- focusColumn: UnsafeMutablePointer<GtkTreeViewColumn>?
	///	- focusCell: UnsafeMutablePointer<GtkCellRenderer>?
	///	- startEditing: Bool
	open func setCursorOnCell(path: OpaquePointer!, focusColumn: UnsafeMutablePointer<GtkTreeViewColumn>?, focusCell: UnsafeMutablePointer<GtkCellRenderer>?, startEditing: Bool) {
	...
	/// Parameters:
	///	- function: @escaping GtkTreeDestroyCountFunc
	///	- data: gpointer
	///	- destroy: @escaping GDestroyNotify
	open func setDestroyCountFunc(_ function: @escaping GtkTreeDestroyCountFunc, data: gpointer, destroy: @escaping GDestroyNotify) {
	...
	open func setDragDestRow(path: OpaquePointer?, pos: GtkTreeViewDropPosition) {
	...
	/// Parameters:
	///	- enableSearch: Bool
	open func setEnableSearch(_ enableSearch: Bool) {
	...
	/// Parameters:
	///	- enabled: Bool
	open func setEnableTreeLines(enabled: Bool) {
	...
	/// Parameters:
	///	- column: UnsafeMutablePointer<GtkTreeViewColumn>!
	open func setExpanderColumn(_ column: UnsafeMutablePointer<GtkTreeViewColumn>!) {
	...
	/// Parameters:
	///	- enable: Bool
	open func setFixedHeightMode(enable: Bool) {
	...
	/// Parameters:
	///	- gridLines: GtkTreeViewGridLines
	open func setGridLines(_ gridLines: GtkTreeViewGridLines) {
	...
	/// Parameters:
	///	- setting: Bool
	open func setHeadersClickable(setting: Bool) {
	...
	/// Parameters:
	///	- headersVisible: Bool
	open func setHeadersVisible(_ headersVisible: Bool) {
	...
	/// Parameters:
	///	- expand: Bool
	open func setHoverExpand(_ expand: Bool) {
	...
	/// Parameters:
	///	- hover: Bool
	open func setHoverSelection(hover: Bool) {
	...
	/// Parameters:
	///	- indentation: gint
	open func setLevelIndentation(_ indentation: gint) {
	...
	/// Parameters:
	///	- enable: Bool
	open func setRubberBanding(enable: Bool) {
	...
	/// Parameters:
	///	- setting: Bool
	open func setRulesHint(setting: Bool) {
	...
	/// Parameters:
	///	- column: gint
	open func setSearchColumn(_ column: gint) {
	...
	open func setSearchEntry(_ entry: UnsafeMutablePointer<GtkEntry>?) {
	...
	/// Parameters:
	///	- searchEqualFunc: @escaping GtkTreeViewSearchEqualFunc
	///	- searchUserData: gpointer
	///	- searchDestroy: @escaping GDestroyNotify
	open func setSearchEqualFunc(_ searchEqualFunc: @escaping GtkTreeViewSearchEqualFunc, searchUserData: gpointer, searchDestroy: @escaping GDestroyNotify) {
	...
	/// Parameters:
	///	- function: @escaping GtkTreeViewSearchPositionFunc
	///	- data: gpointer
	///	- destroy: @escaping GDestroyNotify
	open func setSearchPositionFunc(_ function: @escaping GtkTreeViewSearchPositionFunc, data: gpointer, destroy: @escaping GDestroyNotify) {
	...
	/// Parameters:
	///	- enabled: Bool
	open func setShowExpanders(enabled: Bool) {
	...
	///	- column: UnsafeMutablePointer<GtkTreeViewColumn>?
	///	- cell: UnsafeMutablePointer<GtkCellRenderer>?
	open func setTooltipCell(tooltip: OpaquePointer!, path: OpaquePointer?, column: UnsafeMutablePointer<GtkTreeViewColumn>?, cell: UnsafeMutablePointer<GtkCellRenderer>?) {
	...
	///	- tooltip: OpaquePointer!
	///	- path: OpaquePointer!
	open func setTooltipRow(tooltip: OpaquePointer!, path: OpaquePointer!) {
