...
open class CGTKAssistant : CGTKWindow {
	...
	/// Parameters:
	///	- child: CGTKWidget
	open func addActionWidget(child: CGTKWidget) {
	...
	/// Parameters:
	///	- child: CGTKWidget
	open func removeActionWidget(child: CGTKWidget) {
	...
	/// next visible page.
	/// Parameters:
	///	- pageFunc: @escaping GtkAssistantPageFunc
	///	- data: gpointer
	///	- destroy: @escaping GDestroyNotify
	open func setForwardPageFunc(_ pageFunc: @escaping GtkAssistantPageFunc, data: gpointer, destroy: @escaping GDestroyNotify) {
	...
	///	- page: CGTKWidget
	///	- complete: Bool
	open func setPageComplete(page: CGTKWidget, complete: Bool) {
	...
	///	- page: CGTKWidget
	///	- hasPadding: Bool
	open func setPageHasPadding(page: CGTKWidget, hasPadding: Bool) {
	...
	open func setPageHeaderImage(page: CGTKWidget, pixbuf: OpaquePointer?) {
	...
	///	- page: CGTKWidget
	///	- pixbuf: OpaquePointer?
	open func setPageSideImage(page: CGTKWidget, pixbuf: OpaquePointer?) {
	...
	///	- page: CGTKWidget
	///	- title: String
	open func setPageTitle(page: CGTKWidget, title: String) {
	...
	open func setPageType(page: CGTKWidget, type: GtkAssistantPageType) {
