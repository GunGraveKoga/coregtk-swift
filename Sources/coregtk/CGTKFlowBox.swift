...
open class CGTKFlowBox : CGTKContainer {
	/// 
	...
	/// Parameters:
	///	- model: OpaquePointer?
	///	- createWidgetFunc: @escaping GtkFlowBoxCreateWidgetFunc
	///	- userData: gpointer
	///	- userDataFreeFunc: @escaping GDestroyNotify
	open func bindModel(_ model: OpaquePointer?, createWidgetFunc: @escaping GtkFlowBoxCreateWidgetFunc, userData: gpointer, userDataFreeFunc: @escaping GDestroyNotify) {
	...
	/// Parameters:
	///	- idx: gint
	/// - Returns: UnsafeMutablePointer<GtkFlowBoxChild>?
	...
	///	- widget: CGTKWidget
	///	- position: gint
	open func insert(widget: CGTKWidget, position: gint) {
	...
	/// mode allows it.
	/// Parameters:
	///	- child: UnsafeMutablePointer<GtkFlowBoxChild>!
	open func selectChild(_ child: UnsafeMutablePointer<GtkFlowBoxChild>!) {
	...
	/// this function.
	/// Parameters:
	///	- function: @escaping GtkFlowBoxForeachFunc
	///	- data: gpointer
	open func selectedForeach(function: @escaping GtkFlowBoxForeachFunc, data: gpointer) {
	...
	/// Parameters:
	///	- filterFunc: @escaping GtkFlowBoxFilterFunc
	///	- userData: gpointer
	///	- destroy: @escaping GDestroyNotify
	open func setFilterFunc(_ filterFunc: @escaping GtkFlowBoxFilterFunc, userData: gpointer, destroy: @escaping GDestroyNotify) {
	...
	/// Parameters:
	///	- nchildren: guint
	open func setMaxChildrenPerLine(nchildren: guint) {
	...
	/// Parameters:
	///	- nchildren: guint
	open func setMinChildrenPerLine(nchildren: guint) {
	...
	/// (see gtk_flow_box_bind_model()).
	/// Parameters:
	///	- sortFunc: @escaping GtkFlowBoxSortFunc
	///	- userData: gpointer
	///	- destroy: @escaping GDestroyNotify
	open func setSortFunc(_ sortFunc: @escaping GtkFlowBoxSortFunc, userData: gpointer, destroy: @escaping GDestroyNotify) {
	...
	/// Parameters:
	///	- child: UnsafeMutablePointer<GtkFlowBoxChild>!
	open func unselectChild(_ child: UnsafeMutablePointer<GtkFlowBoxChild>!) {
