...
open class CGTKStack : CGTKContainer {
	...
	open func addNamed(child: CGTKWidget, name: String) -> Swift.Void {
	...
	open func addTitled(child: CGTKWidget, name: String, title: String) -> Swift.Void {
	...
	/// - Returns: GtkStackTransitionType (GtkStackTransitionType)
	...
	/// - Parameters:
	///	- hhomogeneous: Bool (gboolean)
	open func setHhomogeneous(_ hhomogeneous: Bool) -> Swift.Void {
	...
	/// - Parameters:
	///	- interpolateSize: Bool (gboolean)
	open func setInterpolateSize(_ interpolateSize: Bool) -> Swift.Void {
	...
	/// - Parameters:
	///	- transition: GtkStackTransitionType (GtkStackTransitionType)
	open func setTransitionType(transition: GtkStackTransitionType) -> Swift.Void {
	...
	/// - Parameters:
	///	- vhomogeneous: Bool (gboolean)
	open func setVhomogeneous(_ vhomogeneous: Bool) -> Swift.Void {
	...
	/// - Parameters:
	///	- child: CGTKWidget (GtkWidget*)
	open func setVisibleChild(_ child: CGTKWidget) -> Swift.Void {
	...
	///	- name: String (const gchar*)
	///	- transition: GtkStackTransitionType (GtkStackTransitionType)
	open func setVisibleChildFull(name: String, transition: GtkStackTransitionType) -> Swift.Void {
	...
	/// - Parameters:
	///	- name: String (const gchar*)
	open func setVisibleChildName(_ name: String) -> Swift.Void {
