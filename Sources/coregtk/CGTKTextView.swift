...
open class CGTKTextView : CGTKContainer {
	/// 
	...
	/// Parameters:
	///	- buffer: UnsafeMutablePointer<GtkTextBuffer>!
	/// - Returns: CGTKWidget
	...
	/// Parameters:
	///	- child: CGTKWidget
	///	- anchor: UnsafeMutablePointer<GtkTextChildAnchor>!
	open func addChildAtAnchor(child: CGTKWidget, anchor: UnsafeMutablePointer<GtkTextChildAnchor>!) {
	...
	/// Parameters:
	///	- child: CGTKWidget
	///	- whichWindow: GtkTextWindowType
	///	- xpos: gint
	///	- ypos: gint
	open func addChildInWindow(child: CGTKWidget, whichWindow: GtkTextWindowType, xpos: gint, ypos: gint) {
	...
	/// Parameters:
	///	- iter: UnsafeMutablePointer<GtkTextIter>!
	/// - Returns: Bool
	...
	///	- bufferX: gint
	///	- bufferY: gint
	///	- windowX: UnsafeMutablePointer<Int32>!
	///	- windowY: UnsafeMutablePointer<Int32>!
	open func bufferToWindowCoords(win: GtkTextWindowType, bufferX: gint, bufferY: gint, windowX: UnsafeMutablePointer<Int32>!, windowY: UnsafeMutablePointer<Int32>!) {
	...
	/// - Returns: UnsafeMutablePointer<GtkTextBuffer>!
	...
	/// Parameters:
	///	- iter: UnsafePointer<GtkTextIter>?
	///	- strong: UnsafeMutablePointer<GdkRectangle>!
	///	- weak: UnsafeMutablePointer<GdkRectangle>!
	open func getCursorLocations(iter: UnsafePointer<GtkTextIter>?, strong: UnsafeMutablePointer<GdkRectangle>!, weak: UnsafeMutablePointer<GdkRectangle>!) {
	...
	/// - Returns: UnsafeMutablePointer<GtkTextAttributes>!
	...
	/// Parameters:
	///	- iter: UnsafeMutablePointer<GtkTextIter>!
	///	- trailing: UnsafeMutablePointer<Int32>!
	///	- x: gint
	///	- y: gint
	/// - Returns: Bool
	...
	/// Parameters:
	///	- iter: UnsafePointer<GtkTextIter>!
	///	- location: UnsafeMutablePointer<GdkRectangle>!
	open func getIterLocation(iter: UnsafePointer<GtkTextIter>!, location: UnsafeMutablePointer<GdkRectangle>!) {
	...
	/// edge of the line.
	/// Parameters:
	///	- targetIter: UnsafeMutablePointer<GtkTextIter>!
	///	- y: gint
	///	- lineTop: UnsafeMutablePointer<Int32>!
	open func getLineAtY(targetIter: UnsafeMutablePointer<GtkTextIter>!, y: gint, lineTop: UnsafeMutablePointer<Int32>!) {
	...
	open func getLineYrange(iter: UnsafePointer<GtkTextIter>!, y: UnsafeMutablePointer<Int32>!, height: UnsafeMutablePointer<Int32>!) {
	...
	///	- xpos: gint
	///	- ypos: gint
	open func moveChild(_ child: CGTKWidget, xpos: gint, ypos: gint) {
	...
	/// Parameters:
	///	- mark: UnsafeMutablePointer<GtkTextMark>!
	/// - Returns: Bool
	...
	/// Parameters:
	///	- mark: UnsafeMutablePointer<GtkTextMark>!
	open func scrollMarkOnscreen(mark: UnsafeMutablePointer<GtkTextMark>!) {
	...
	///	- xalign: Double
	///	- yalign: Double
	open func scrollToMark(_ mark: UnsafeMutablePointer<GtkTextMark>!, withinMargin: Double, useAlign: Bool, xalign: Double, yalign: Double) {
	...
	/// Parameters:
	///	- acceptsTab: Bool
	open func setAcceptsTab(_ acceptsTab: Bool) {
	...
	///	- type: GtkTextWindowType
	///	- size: gint
	open func setBorderWindowSize(type: GtkTextWindowType, size: gint) {
	...
	/// Parameters:
	///	- bottomMargin: gint
	open func setBottomMargin(_ bottomMargin: gint) {
	...
	/// Parameters:
	///	- buffer: UnsafeMutablePointer<GtkTextBuffer>?
	open func setBuffer(_ buffer: UnsafeMutablePointer<GtkTextBuffer>?) {
	...
	/// Parameters:
	///	- setting: Bool
	open func setCursorVisible(setting: Bool) {
	...
	/// Parameters:
	///	- setting: Bool
	open func setEditable(setting: Bool) {
	...
	/// Parameters:
	///	- indent: gint
	open func setIndent(_ indent: gint) {
	...
	open func setJustification(_ justification: GtkJustification) {
	...
	/// Parameters:
	///	- leftMargin: gint
	open func setLeftMargin(_ leftMargin: gint) {
	...
	/// Parameters:
	///	- monospace: Bool
	open func setMonospace(_ monospace: Bool) {
	...
	/// Parameters:
	///	- overwrite: Bool
	open func setOverwrite(_ overwrite: Bool) {
	...
	open func setPixelsAboveLines(_ pixelsAboveLines: gint) {
	...
	open func setPixelsBelowLines(_ pixelsBelowLines: gint) {
	...
	open func setPixelsInsideWrap(_ pixelsInsideWrap: gint) {
	...
	/// Parameters:
	///	- rightMargin: gint
	open func setRightMargin(_ rightMargin: gint) {
	...
	/// Parameters:
	///	- topMargin: gint
	open func setTopMargin(_ topMargin: gint) {
	...
	open func setWrapMode(_ wrapMode: GtkWrapMode) {
	...
	///	- windowX: gint
	///	- windowY: gint
	///	- bufferX: UnsafeMutablePointer<Int32>!
	///	- bufferY: UnsafeMutablePointer<Int32>!
	open func windowToBufferCoords(win: GtkTextWindowType, windowX: gint, windowY: gint, bufferX: UnsafeMutablePointer<Int32>!, bufferY: UnsafeMutablePointer<Int32>!) {
