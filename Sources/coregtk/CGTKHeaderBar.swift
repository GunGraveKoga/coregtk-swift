...
open class CGTKHeaderBar : CGTKContainer {
	...
	/// Parameters:
	///	- titleWidget: CGTKWidget
	open func setCustomTitle(titleWidget: CGTKWidget) {
	...
	/// Parameters:
	///	- layout: String
	open func setDecorationLayout(_ layout: String) {
	...
	/// Parameters:
	///	- setting: Bool
	open func setHasSubtitle(setting: Bool) {
