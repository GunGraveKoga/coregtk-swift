...
open class CGTKGrid : CGTKContainer, CGTKOrientable {
	...
	///	- width: gint (gint)
	///	- height: gint (gint)
	open func attach(child: CGTKWidget, left: gint, top: gint, width: gint, height: gint) -> Swift.Void {
	...
	/// - Parameters:
	///	- position: gint (gint)
	open func insertColumn(position: gint) -> Swift.Void {
	...
	///	- sibling: CGTKWidget (GtkWidget*)
	///	- side: GtkPositionType (GtkPositionType)
	open func insertNextTo(sibling: CGTKWidget, side: GtkPositionType) -> Swift.Void {
	...
	/// - Parameters:
	///	- position: gint (gint)
	open func insertRow(position: gint) -> Swift.Void {
	...
	/// - Parameters:
	///	- position: gint (gint)
	open func removeColumn(position: gint) -> Swift.Void {
	...
	/// - Parameters:
	///	- position: gint (gint)
	open func removeRow(position: gint) -> Swift.Void {
	...
	/// - Parameters:
	///	- row: gint (gint)
	open func setBaselineRow(_ row: gint) -> Swift.Void {
	...
	open func setColumnHomogeneous(_ homogeneous: Bool) -> Swift.Void {
	...
	/// - Parameters:
	///	- row: gint (gint)
	///	- pos: GtkBaselinePosition (GtkBaselinePosition)
	open func setRowBaselinePosition(row: gint, pos: GtkBaselinePosition) -> Swift.Void {
	...
	/// - Parameters:
	///	- homogeneous: Bool (gboolean)
	open func setRowHomogeneous(_ homogeneous: Bool) -> Swift.Void {
