...
open class CGTKMenuButton : CGTKToggleButton {
	...
	/// - Returns: UnsafeMutablePointer<GMenuModel>?
	...
	/// returns %NULL.
	/// - Returns: UnsafeMutablePointer<GtkPopover>?
	...
	/// returns %NULL.
	/// - Returns: UnsafeMutablePointer<GtkMenu>?
	...
	/// Parameters:
	///	- alignWidget: CGTKWidget
	open func setAlignWidget(_ alignWidget: CGTKWidget) {
	...
	open func setDirection(_ direction: GtkArrowType) {
	...
	open func setMenuModel(_ menuModel: UnsafeMutablePointer<GMenuModel>?) {
	...
	/// Parameters:
	///	- popover: CGTKWidget
	open func setPopover(_ popover: CGTKWidget) {
	...
	/// Parameters:
	///	- menu: CGTKWidget
	open func setPopup(menu: CGTKWidget) {
	...
	/// Parameters:
	///	- usePopover: Bool
	open func setUsePopover(_ usePopover: Bool) {
