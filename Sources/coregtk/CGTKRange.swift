...
open class CGTKRange : CGTKWidget {
	...
	/// This function is useful mainly for #GtkRange subclasses.
	/// Parameters:
	///	- rangeRect: UnsafeMutablePointer<GdkRectangle>!
	open func getRangeRect(_ rangeRect: UnsafeMutablePointer<GdkRectangle>!) {
	...
	/// This function is useful mainly for #GtkRange subclasses.
	/// Parameters:
	///	- sliderStart: UnsafeMutablePointer<Int32>!
	///	- sliderEnd: UnsafeMutablePointer<Int32>!
	open func getSliderRange(sliderStart: UnsafeMutablePointer<Int32>!, sliderEnd: UnsafeMutablePointer<Int32>!) {
	...
	/// Parameters:
	///	- fillLevel: Double
	open func setFillLevel(_ fillLevel: Double) {
	...
	/// Parameters:
	///	- flippable: Bool
	open func setFlippable(_ flippable: Bool) {
	...
	/// Parameters:
	///	- setting: Bool
	open func setInverted(setting: Bool) {
	...
	open func setLowerStepperSensitivity(_ sensitivity: GtkSensitivityType) {
	...
	/// Parameters:
	///	- minSize: gint
	open func setMinSliderSize(minSize: gint) {
	...
	open func setRestrictToFillLevel(_ restrictToFillLevel: Bool) {
	...
	/// Parameters:
	///	- roundDigits: gint
	open func setRoundDigits(_ roundDigits: gint) {
	...
	/// Parameters:
	///	- showFillLevel: Bool
	open func setShowFillLevel(_ showFillLevel: Bool) {
	...
	/// Parameters:
	///	- sizeFixed: Bool
	open func setSliderSizeFixed(_ sizeFixed: Bool) {
	...
	/// Parameters:
	///	- sensitivity: GtkSensitivityType
	open func setUpperStepperSensitivity(_ sensitivity: GtkSensitivityType) {
