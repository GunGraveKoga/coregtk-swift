...
public let GTK_TYPE_ACTIVATABLE: GType = gtk_activatable_get_type()

@inline(__always) public func GTK_ACTIVATABLE(_ ptr: UnsafeMutableRawPointer!) -> OpaquePointer! {
	return G_TYPE_CHECK_INSTANCE_CAST(ptr, GTK_TYPE_ACTIVATABLE)
}
...
public protocol CGTKActivatable: class {
	...
	func doSetRelatedAction(_ action: UnsafeMutablePointer<GtkAction>!) -> Swift.Void

	/// Gets the related #GtkAction for @activatable.
	/// - Returns: UnsafeMutablePointer<GtkAction>! (GtkAction*)
	func getRelatedAction() -> UnsafeMutablePointer<GtkAction>!

	/// Gets whether this activatable should reset its layout
	/// and appearance when setting the related action or when
	/// the action changes appearance.
	/// - Returns: Bool (gboolean)
	func getUseActionAppearance() -> Bool
	...
	/// - Parameters:
	///	- action: UnsafeMutablePointer<GtkAction>! (GtkAction*)
	func setRelatedAction(_ action: UnsafeMutablePointer<GtkAction>!) -> Swift.Void
	...
	func setUseActionAppearance(useAppearance: Bool) -> Swift.Void
	...
	/// - Parameters:
	///	- action: UnsafeMutablePointer<GtkAction>? (GtkAction*)
	func syncActionProperties(action: UnsafeMutablePointer<GtkAction>?) -> Swift.Void
