...
open class CGTKHSV : CGTKWidget {
	...
	///	- s: Double
	///	- v: Double
	///	- r: UnsafeMutablePointer<Double>!
	///	- g: UnsafeMutablePointer<Double>!
	///	- b: UnsafeMutablePointer<Double>!
	open class func gtkHsvToRgb(h: Double, s: Double, v: Double, r: UnsafeMutablePointer<Double>!, g: UnsafeMutablePointer<Double>!, b: UnsafeMutablePointer<Double>!) {
	...
	/// Parameters:
	///	- h: UnsafeMutablePointer<Double>!
	///	- s: UnsafeMutablePointer<Double>!
	///	- v: UnsafeMutablePointer<Double>!
	open func gtkHsvGetColor(h: UnsafeMutablePointer<Double>!, s: UnsafeMutablePointer<Double>!, v: UnsafeMutablePointer<Double>!) {
	...
	///	- ringWidth: UnsafeMutablePointer<Int32>!
	open func gtkHsvGetMetrics(size: UnsafeMutablePointer<Int32>!, ringWidth: UnsafeMutablePointer<Int32>!) {
	...
	///	- s: Double
	///	- v: Double
	open func gtkHsvSetColor(h: Double, s: Double, v: Double) {
	...
	///	- size: gint
	///	- ringWidth: gint
	open func gtkHsvSetMetrics(size: gint, ringWidth: gint) {
